...
# # frame
# frameCnt = 2
# frames = [PhotoImage(file='./3조/asd/fi1.gif', format='gif -index %i' % (i)) for i in range(frameCnt)]
#
# def update(ind):
#     frame = frames[ind]
#     ind += 1
...
class MyApp:
    def __init__(self):
        ...
        # set image
        self.tk_image1 = PhotoImage(file='./3조/asd/fi1.gif')
        self.tk_image2 = PhotoImage(file='./3조/asd/f6.gif')
        self.imageNum = 1
