...
let plengB =document.getElementById('widthL');
let plengS= getComputedStyle(plengB);
let cct=1;
let plengSWM =0;
let plengSw= parseInt(plengS.width.split("p")[0]);
let pgB=0;
...
// pg1.style.width= plengSw-20+"px";
// pg2.style.width= plengSw-20+"px";
// pg3.style.width= plengSw-20+"px";
...
function mouClk1(){
    ...
    if (this==platnh1){
        ...
        // pleng.style.width=pleng.style.width;
        ...
        pleng =modal5.querySelector("#widthL");
