...
// let inw= window.addEventListener("keydown", (e) => console.log(e));


let Amodal= document.querySelector(".modal-overlay");
let ki1= Amodal.addEventListener("keydown",  (e) => console.log(e));
