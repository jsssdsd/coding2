...
window.onscroll = function() {
    ...
    /offset 은 부모로부터의 차를 불러온다. top 부모로부터 top여백값이 얼마인가?/ 
    console.log('program_offsetTop',program_offsetTop)
    reactBG.style.height = program_offsetTop + "px";
    ...
    if (window.scrollY + membershipDiv.scrollHeight +50 >= footerW.offsetTop )
    {
