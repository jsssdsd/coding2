...
function moveCanvas() {
	...
	if(user.x <= 3200-640 && user.x >= -3200+640)
	{
		if (user.y >= 610)
		{
			ctx.drawImage(img, imgCenterX+user.x, imgCenterY-610, canvas.width, canvas.height, 0, 0, canvas.width, canvas.height);
		}
		else
		{
	...
	else
	{
		if (user.x > 3200-640)
		{
			if (user.y >= 610)
			{
				ctx.drawImage(img, imgCenterX+3200-640, imgCenterY-610, canvas.width, canvas.height, 0, 0, canvas.width, canvas.height);
			}
			else
			{
