		...
		function animatedUser() {
			if (user.x <= 3200-640 && user.x >= -3200+640)
			{
				if (user.y >= 640)
				{
					...
					ctxUser.drawImage(userImg[countFrame],canvas.width/2-60,canvas.height-126-65-(user.y-640));
					countFrame+=1;
...
function moveCanvas() {
	...
	if(user.x <= 3200-640 && user.x >= -3200+640)
	{
		if (user.y >= 640)
		{
			ctx.drawImage(img, imgCenterX+user.x, imgCenterY-640, canvas.width, canvas.height, 0, 0, canvas.width, canvas.height);
		}
		else
		{
	...
	else
	{
		if (user.x > 3200-640)
		{
			if (user.y >= 640)
			{
				ctx.drawImage(img, imgCenterX+3200-640, imgCenterY-640, canvas.width, canvas.height, 0, 0, canvas.width, canvas.height);
			}
			else
			{
		...
		else if (user.x < -3200+640)
		{
			if (user.y >= 620)
			{
				ctx.drawImage(img, imgCenterX-3200+640, imgCenterY-620, canvas.width, canvas.height, 0, 0, canvas.width, canvas.height);
			}
			else
			{
				ctx.drawImage(img, imgCenterX-3200+640, imgCenterY-user.y, canvas.width, canvas.height, 0, 0, canvas.width, canvas.height);
